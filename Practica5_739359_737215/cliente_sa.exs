...
# FECHA: 20/12/2018
# TIEMPO: 15 horas
# DESCRIPCIÓN: Cliente del sistema de almacenamiento. Ha sido modificado del original 
#              en que se ha añadido el parámetro id a todas las operaciones.
...
defmodule ClienteSA do
    ...
    """
    @spec lee( node(), String.t, Integer.id) :: String.t
    ...
    @doc """
       ...
       La especificación del interfaz de la función es la siguiente :
                            (se puede utilizar también para "dialyzer")
    """
    @spec escribe_generico( node(), String.t, String.t, boolean, Integer.id ) :: String.t
    ...
    """
    @spec escribe( node(), String.t, String.t, Integer.id ) :: String.t
    ...
    """
    @spec escribe_hash( node(), String.t, String.t, Integer.id) :: String.t
